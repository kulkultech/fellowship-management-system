              ...
              {allPrograms.length === 0 ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-left text-xs sm:text-sm">
                    <thead className="bg-slate-50/80 text-2xs uppercase tracking-wider text-slate-500 font-bold border-b border-slate-100">
                      <tr>
                        <th className="py-3.5 px-4 font-bold">Program Details</th>
                        <th className="py-3.5 px-4 font-bold">Cohort Window</th>
                        <th className="py-3.5 px-4 font-bold text-center">Specialization Tracks</th>
                          ...
                          >
                            <td className="py-4 px-4">
                              <div className="flex items-center gap-3.5">
                                ...
                                <div>
                                  <div className="font-extrabold text-slate-900 group-hover:text-kulkul-purple transition text-sm sm:text-base flex items-center gap-2">
                                    <span>{prog.name}</span>
                                    {isSelected && (
                            ...
                            <td className="py-4 px-4 whitespace-nowrap text-xs text-slate-600">
                              ...
                              <div className="text-2xs text-slate-400 mt-0.5 flex items-center gap-1">
                                <Clock className="w-3 h-3 text-kulkul-orange" />
                            ...
                            <td className="py-4 px-4 text-center whitespace-nowrap">
                              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-bold bg-purple-50 text-kulkul-purple border border-purple-200">
                                ...
                                {prog.tracks ? prog.tracks.length : (prog.slug === activeProgramSlug ? programTracks.length : '2')} Tracks
                              </span>
                            </td>
