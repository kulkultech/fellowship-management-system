        ...
        <div className="p-6 space-y-5 overflow-y-auto">
          ...
          <div className="space-y-2">
            ...
            <div className="flex justify-center items-center w-full bg-slate-900/5 p-3 rounded-2xl border border-slate-200/80 min-h-[220px]">
              ...
              >
                {/* Loading indicator until image completes loading */}
                {!imageLoaded && !loadError && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-950/80 text-slate-400 gap-2 z-10">
                    <Loader2 className="w-6 h-6 text-kulkul-purple animate-spin" />
                    <span className="text-xs font-semibold text-slate-300">Loading banner preview...</span>
                  </div>
                )}
                ...
                {displaySrc && (
                  <img
                    ...
                    onError={() => {
                      // If direct source failed and we haven't tried backend proxy yet, try proxying
                      if (
                        !hasTriedProxy &&
                        displaySrc &&
